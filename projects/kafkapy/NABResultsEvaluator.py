...
def eval_results(results_path, csv_out_path, percentage_to_drop=0, from_start=True):
    ...
    df_rows = df_rows[['dataset','time_serie','classifier','total','tp','tn','fp','fn','precision','recall','f1','fbeta','accuracy']]
...
if __name__ == "__main__":
    ...
    ptd = int(args.ptd)
    eval_results(args.results_path, args.csv_out_path, ptd, args.from_start)
