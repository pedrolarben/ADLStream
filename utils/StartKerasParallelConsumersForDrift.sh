...
#topics=(streams_ARGWg-F3F6F3F6)
topics=(streams_RTGgD streams_RTGaD streams_RTGg3D streams_RTGa3D )
#streams_ARGWg-F2F5F8 streams_ARGWa-F3F6F3F6 streams_ARGWa-F2F5F8 streams_ARGWg-F1F10 streams_RBFi-slow streams_RBFi-fast streams_RTGa3 streams_RTGa streams_RTGg3 streams_SEAg-F2F4 streams_SEAa-F2F4 streams_ARGWa-F1F10 streams_ARGWg-F3F6F3F6) 
