...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/RBFi-fast.png "Evolution of RBFi-fast prequential kappa results.")
...
![](../utils/notebooks/files/drift/kappa/RTGa.png "Evolution of RTGa prequential kappa results.")
...
![](../utils/notebooks/files/drift/kappa/RTGa3.png "Evolution of RTGa3 prequential kappa results.")
...
WriteStreamToARFFFile 
	...
	-m 1000000
```
![](../utils/notebooks/files/drift/kappa/ARGWa-F1F10.png "Evolution of ARGWa-F1F10 prequential kappa results.")
...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/ARGWa-F2F5F8.png "Evolution of ARGWa-F2F5F8 prequential kappa results.")
...
![](../utils/notebooks/files/drift/kappa/ARGWa-F3F6F3F6.png "Evolution of ARGWa-F3F6F3F6 prequential kappa results.")

#### SEAa-F2F4
This stream implement an **abrupt** drift from SEA's function 2 to SEA's function 4 in the instance 500k
```
WriteStreamToARFFFile 
	-s (ConceptDriftStream 
	...
	-m 1000000
```
![](../utils/notebooks/files/drift/kappa/SEAa-F2F4.png "Evolution of SEAa-F2F4 prequential kappa results.")
...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/RTGg.png "Evolution of RTGg prequential kappa results.")
...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/RTGg3.png "Evolution of RTGg3 prequential kappa results.")
...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/ARGWg-F2F5F8.png "Evolution of ARGWg-F2F5F8 prequential kappa results.")
...
WriteStreamToARFFFile 
    ...
    -m 1000000
```
![](../utils/notebooks/files/drift/kappa/ARGWg-F3F6F3F6.png "Evolution of ARGWg-F3F6F3F6 prequential kappa results.")
...
WriteStreamToARFFFile 
	...
	-m 1000000
```
![](../utils/notebooks/files/drift/kappa/SEAg-F2F4.png "Evolution of SEAg-F2F4 prequential kappa results.")
